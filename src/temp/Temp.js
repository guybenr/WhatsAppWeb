                    ...
                    <div class="side-one">
                        ...
                        <div class="row sideBar">
                                ...
                                <div class="col-sm-9 col-xs-9 sideBar-main">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 col-xs-4 pull-right sideBar-time">
                                            <span class="time-meta pull-right">18:19
                                            </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row sideBar-body">
                                <div class="col-sm-3 col-xs-3 sideBar-avatar">
                                    <div class="avatar-icon">
                                        <img src="https://bootdey.com/img/Content/avatar/avatar4.png"></img>
                                    </div>
                                </div>
                                <div class="col-sm-9 col-xs-9 sideBar-main">
                                    <div class="row">
                    ...
                    <div class="side-two">
                        ...
                        <div class="row composeBox">
                            <div class="col-sm-12 composeBox-inner">
                                <div class="form-group has-feedback">
                                    <input id="composeText" type="text" class="form-control" name="searchText" placeholder="Search People"></input>
                                    <span class="glyphicon glyphicon-search form-control-feedback"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row message-body">
                            <div class="col-sm-12 message-main-receiver">
                                <div class="receiver">
                                    ...
                                    <span class="message-time">Sun</span>
                                </div>
                            </div>
                        </div>
